...
public interface LanguageService {
    ...
    /**
	 * Find and return the Language for given code  if exists.
	 *
	 * @param code value of code; value cannot be null.
	 * @return Language associated with the given inputs.
     * @throws EntityNotFoundException if no matching Language found.
	 */
    Language getByCode(String code)throws EntityNotFoundException;
    ...
    /*
     * Returns the associated personnameotherlanguages for given Language id.
     *
    ...
    /*
     * Returns the associated personlanguages for given Language id.
     *
     * @param pk value of pk; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
