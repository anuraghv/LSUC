...
public interface GenderService {
	 ...
	 */
	Gender getById(Integer genderId) throws EntityNotFoundException;
    ...
    /**
	 * Find and return the Gender for given code  if exists.
	 *
	 * @param code value of code; value cannot be null.
	 * @return Gender associated with the given inputs.
     * @throws EntityNotFoundException if no matching Gender found.
	 */
    Gender getByCode(String code)throws EntityNotFoundException;
	 ...
	 */
	Gender update(Gender gender) throws EntityNotFoundException;
	 ...
	 */
	Gender delete(Integer genderId) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated persons for given Gender id.
     *
