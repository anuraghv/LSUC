...
public class ClassEntityController {
    ...
    public ClassEntity getByCodeAndPracticeElgibilityFk(@RequestParam(name = "code") String code, @RequestParam(name = "practiceElgibilityFk") Integer practiceElgibilityFk) {
