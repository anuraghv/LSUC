...
public class PracticegroupController {
    ...
    public Practicegroup getByCodeAndPracticeEligibilityFk(@RequestParam(name = "code") String code, @RequestParam(name = "practiceEligibilityFk") Integer practiceEligibilityFk) {
