...
public class LicenseeinsuranceController {
    ...
    public Licenseeinsurance getByLicenseeFkAndInsuranceCoverageTypeFk(@RequestParam(name = "licenseeFk") Integer licenseeFk, @RequestParam(name = "insuranceCoverageTypeFk") Integer insuranceCoverageTypeFk) {
