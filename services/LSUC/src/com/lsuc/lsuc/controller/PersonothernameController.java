...
public class PersonothernameController {
    ...
    public Personothername getByPersonFkAndOtherNameTypeFk(@RequestParam(name = "personFk") Integer personFk, @RequestParam(name = "otherNameTypeFk") Integer otherNameTypeFk) {
