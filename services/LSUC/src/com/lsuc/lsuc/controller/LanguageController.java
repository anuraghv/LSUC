...
import com.lsuc.lsuc.service.LanguageService;
...
public class LanguageController {
    ...
    public Language editLanguage(@PathVariable("id") Integer id, @RequestBody Language language) throws EntityNotFoundException {
        LOGGER.debug("Editing Language with id: {}" , language.getPk());
    ...
    @ApiOperation(value = "Returns the matching Language with given unique key values.")
    public Language getByCode(@PathVariable("code") String code) {
        LOGGER.debug("Getting Language with uniques key Code");
    ...
    public Page<Personnameotherlanguage> findAssociatedPersonnameotherlanguages(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return languageService.findAssociatedPersonnameotherlanguages(id, pageable);
    }
    ...
    public Page<Personlanguage> findAssociatedPersonlanguages(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return languageService.findAssociatedPersonlanguages(id, pageable);
    }
