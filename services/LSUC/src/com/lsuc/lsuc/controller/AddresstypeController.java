...
public class AddresstypeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Addresstype getAddresstype(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Addresstype editAddresstype(@PathVariable("id") Integer id, @RequestBody Addresstype addresstype) throws EntityNotFoundException {
        LOGGER.debug("Editing Addresstype with id: {}" , addresstype.getPk());

        addresstype.setPk(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAddresstype(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Addresstype getByCode(@PathVariable("code") String code) {
        LOGGER.debug("Getting Addresstype with uniques key Code");
    ...
    public Page<Addresstype> searchAddresstypesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Addresstypes list");
    ...
    public Page<Businessaddress> findAssociatedBusinessaddresses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return addresstypeService.findAssociatedBusinessaddresses(id, pageable);
    }
    ...
    public Page<Organizationalunitaddress> findAssociatedOrganizationalunitaddresses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return addresstypeService.findAssociatedOrganizationalunitaddresses(id, pageable);
    }
    ...
    public Page<Personaddress> findAssociatedPersonaddresses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return addresstypeService.findAssociatedPersonaddresses(id, pageable);
    }
