...
import com.lsuc.lsuc.service.UserService;
...
public class UserController {
    ...
    public User editUser(@PathVariable("id") Integer id, @RequestBody User user) throws EntityNotFoundException {
        LOGGER.debug("Editing User with id: {}" , user.getPk());
    ...
    @RequestMapping(value = "/userProfileName/{userProfileName}", method = RequestMethod.GET)
    @ApiOperation(value = "Returns the matching User with given unique key values.")
    public User getByUserProfileName(@PathVariable("userProfileName") String userProfileName) {
        LOGGER.debug("Getting User with uniques key UserProfileName");
        return userService.getByUserProfileName(userProfileName);
    }
    ...
    public Page<Userpreference> findAssociatedUserpreferences(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return userService.findAssociatedUserpreferences(id, pageable);
    }
