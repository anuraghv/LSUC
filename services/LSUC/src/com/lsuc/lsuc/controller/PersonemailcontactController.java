...
public class PersonemailcontactController {
    ...
    public Personemailcontact getByPersonFkAndEmailPurposeFk(@RequestParam(name = "personFk") Integer personFk, @RequestParam(name = "emailPurposeFk") Integer emailPurposeFk) {
