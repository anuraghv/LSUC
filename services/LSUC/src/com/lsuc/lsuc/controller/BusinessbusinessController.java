...
public class BusinessbusinessController {
    ...
    public Businessbusiness getByBusinessFkChildAndBusinessFkParent(@RequestParam(name = "businessFkChild") int businessFkChild, @RequestParam(name = "businessFkParent") int businessFkParent) {
