...
public class BusinesssocialmediacontactController {
    ...
    public Businesssocialmediacontact getByBusinessFkAndSocialMediaTypeFkAndSocialMediaPurposeFk(@RequestParam(name = "businessFk") Integer businessFk, @RequestParam(name = "socialMediaTypeFk") Integer socialMediaTypeFk, @RequestParam(name = "socialMediaPurposeFk") Integer socialMediaPurposeFk) {
