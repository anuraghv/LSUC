...
public class PersonphonecontactController {
    ...
    public Personphonecontact getByPersonFkAndPhonePurposeFkAndPhoneTypeFk(@RequestParam(name = "personFk") Integer personFk, @RequestParam(name = "phonePurposeFk") Integer phonePurposeFk, @RequestParam(name = "phoneTypeFk") Integer phoneTypeFk) {
