...
public class BusinessphonecontactController {
    ...
    public Businessphonecontact getByBusinessFkAndPhonePurposeFkAndPhoneTypeFk(@RequestParam(name = "businessFk") Integer businessFk, @RequestParam(name = "phonePurposeFk") Integer phonePurposeFk, @RequestParam(name = "phoneTypeFk") Integer phoneTypeFk) {
