...
public class LicenseepersonlanguagepurposeController {
    ...
    public Licenseepersonlanguagepurpose getByLicenseeFkAndPersonLanguageFkAndLanguagePurposeFk(@RequestParam(name = "licenseeFk") Integer licenseeFk, @RequestParam(name = "personLanguageFk") Integer personLanguageFk, @RequestParam(name = "languagePurposeFk") Integer languagePurposeFk) {
