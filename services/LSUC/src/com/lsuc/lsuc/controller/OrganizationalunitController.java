...
public class OrganizationalunitController {
    ...
    public Organizationalunit getByBusinessFkAndOrganizationalunitNumber(@RequestParam(name = "businessFk") int businessFk, @RequestParam(name = "organizationalunitNumber") String organizationalunitNumber) {
