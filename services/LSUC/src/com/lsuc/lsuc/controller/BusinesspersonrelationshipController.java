...
public class BusinesspersonrelationshipController {
    ...
    public Businesspersonrelationship getByBusinessPersonFkAndBusinessPersonRelationshipTypeFk(@RequestParam(name = "businessPersonFk") Integer businessPersonFk, @RequestParam(name = "businessPersonRelationshipTypeFk") Integer businessPersonRelationshipTypeFk) {
