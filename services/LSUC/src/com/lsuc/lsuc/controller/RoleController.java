...
public class RoleController {
    ...
    public Role editRole(@PathVariable("id") Integer id, @RequestBody Role role) throws EntityNotFoundException {
        LOGGER.debug("Editing Role with id: {}" , role.getPk());
    ...
    public Role getByCode(@PathVariable("code") String code) {
        LOGGER.debug("Getting Role with uniques key Code");
